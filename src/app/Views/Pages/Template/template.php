        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('dashboard'); ?>">
                <div class="sidebar-brand-icon">
                    ...
                    <img src="<?= base_url('assets/'); ?>img/kamandaka.png" width="px" height="100px" alt="">
                </div>
                <div class="sidebar-brand-text"><sup>BSTK</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#"" data-toggle="collapse" onclick="serviceBstk('list-bstk')">
            ...
            <?php if($role == "admin"):?>
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#"" data-toggle="collapse" onclick="serviceBstk('list-drivers')">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            <a class="nav-link dropdown-toggle" href="#" id="searchDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <isubmit class="fas fa-search fa-fw"></i>
                            </a>
                            <!-- Dropdown - Messages -->
